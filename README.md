...
A data science project to predict **Customer Lifetime Value (CLTV)** for a major e-commerce marketplace using regression modeling.  
This enables the business to target valuable customers, improve retention, and drive marketing ROI.
...
- **Evaluation** 📉  
  - RMSE, MAE metrics for performance
